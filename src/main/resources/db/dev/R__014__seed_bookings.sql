...
WITH seed(block_marker, client_phone, service_title, booking_status, reminder_opt_in, reminder_sent, created_offset) AS (
    VALUES
        ...
        ('[DEV_EXTRA:SPECIALIST_CONFIRMED_HISTORY]', '+380990000011', 'Вісцеральний масаж', 'CONFIRMED', TRUE, TRUE, INTERVAL '-2 days'),
        ('[DEV_EXTRA:OWNER_CONFIRMED_HISTORY]', '+380990000013', 'Комплексний терапевтичний сеанс', 'CONFIRMED', FALSE, FALSE, INTERVAL '-4 days'),
        ('[DEV_EXTRA:SF_PENDING_HISTORY]', '+380990000025', 'Вісцеральний масаж', 'AWAITING_PAYMENT_CONFIRMATION', TRUE, FALSE, INTERVAL '-1 day'),
